...
$txt['default_babylon_theme_name'] = 'Theme Babylon';
...
$txt['error_versions_do_not_match'] = 'El instalador ha detectado otra versión de SMF instalada ya con la informaci&oacute;n especificada. Si usted est&aacute; intentando actualizar, usted debe utilizar el upgrade, no el instalador.<br /><br />Si no, usted puede desear utilizar una informaci&oacute;n diferente, o cree un backup y despu&eacute;s suprima los datos actualmente en la base de datos.';
$txt['error_mod_security'] = 'El instalador ha detectado el m&oacute;dulo del mod_security est&aacute; instalado en su web server. Mod_security bloquear&aacute; formularios enviados antes de que SMF de un aviso o haga algo. SMF tiene incorporado un escaneador de seguridad que funciona mejor que el mod_security y no bloquea nada en las funciones..<br /><br /><a href="http://www.simplemachines.org/redirect/mod_security">M&aacute;s informaci&oacut;n sobre como deshabilitar el mod_security</a>';
