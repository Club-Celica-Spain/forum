...
$helptxt['custom_mask'] = 'The input mask is important for your forum\'s security. Validating the input from a user can help ensure that data is not used in a way you do not expect. We have provided some simple regular expressions as hints.<br /><br />
	...
	$helptxt['inactive_users'] = 'All members below the post count set here will see the activity reminder message.';
$helptxt['show_index_message'] = 'This will enable or disable the message at the index page under the menu'; 
$helptxt['index_message_title'] = 'This is the title of the activity reminder message for the index page. You can use html and smileys';
$helptxt['index_message_body'] = 'This is the message body of the activity reminder message for the index page.You can use html and smileys'; 
$helptxt['show_footer_message'] = 'This will enable or disable the activity reminder message at the footer area'; 
$helptxt['footer_message_title'] = 'This is the title of the activity reminder message for the footer area.You can use html and smileys';
$helptxt['footer_message_body'] = 'This is the message body of the activity reminder message for the footer area. You can use html and smileys';
