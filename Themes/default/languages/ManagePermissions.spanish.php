<?php
// Version: 1.1 RC2; ManagePermissions
...
$txt['permissionname_profile_server_avatar'] = 'Seleccionar un avatar del server';
$txt['permissionhelp_profile_server_avatar'] = 'Este permiso le permite que el usuario pueda escojer un avatar alojado en el servidor.';
$txt['permissionname_profile_upload_avatar'] = 'Subir un avatar al servidor';
$txt['permissionhelp_profile_upload_avatar'] = 'Este permiso le permite al usuario subir su propio avatar al servidor.';
...
$txt['permission_settings_title'] = 'Conf. de Permisos';
$txt['groups_manage_permissions'] = 'Grupos de miembros permitidos para manejar los permisos';
$txt['permission_settings_submit'] = 'Guardar';
$txt['permission_settings_enable_deny'] = 'Habilitar la opci&oacute;n de denegar permisos';
// Escape any single quotes in here twice.. 'it\'s' -> 'it\\\'s'.
$txt['permission_disable_deny_warning'] = 'Desactivar esta opci&oacute;n actualizar&aacute; \\\'Denegar\\\' permisos a \\\'Rechazar\\\'.';
$txt['permission_by_membergroup_desc'] = 'Aqu&i usted puede configurar los permisos globales para cada grupo de miembros. Estos permisos ser&aacute;n v&aacute;lidos en TODOS los foros, pero no a los foros que sean configurados como locales en la pantalla de \'Permisos por Foro\'.';
$txt['permission_by_board_desc'] = 'Aqu&iacute; usted puede fijar si un tablero utiliza los permisos globales o tiene un r&eacute;gimen espec&iacute;fico del permiso. Usar permisos locales significa que para ese tablero, usted puede fijar cada permiso para cada grupo de miembro.';
$txt['permission_settings_desc'] = 'Aqu&iacute; usted puede fijar qui&eacute;n tiene permiso de cambiar permisos, tan bien como c&oacute;mo est&aacute; sofisticado el sistema del permiso debe ser.';
$txt['permission_settings_enable_postgroups'] = 'Habilitar permisos para grupos basados en conteo de mensajes';
// Escape any single quotes in here twice.. 'it\'s' -> 'it\\\'s'.
$txt['permission_disable_postgroups_warning'] = 'Deshabilitar esta configuraci&oacute;n remover&aacute; todos los permisos agregados a grupos basados en conteo de mensajes..';
$txt['permission_settings_enable_by_board'] = 'Habilitar permisos avanzados por foro';
// Escape any single quotes in here twice.. 'it\'s' -> 'it\\\'s'.
$txt['permission_disable_by_board_warning'] = 'Deshabilitar esta configuraci&oacute;n remover&aacute; todos los permisos agregados en este nivel de foro.';
