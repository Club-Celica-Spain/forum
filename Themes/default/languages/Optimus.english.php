...
$txt['optimus_sitemap_desc'] = 'Do you want a simple sitemap? Optimus Brave can generate sitemap.xml for small forums. Just go to <a href="?action=admin;area=scheduledtasks;sa=tasks" target="_blank">Scheduled Tasks</a> and enable Sitemap Generation task.';
...
$txt['optimus_search_stats'] = 'Enable logging of search terms';
$txt['optimus_chart_title'] = 'Search terms - Top %1$s';
$txt['optimus_terms_none'] = 'Statistics are not available. Perhaps your forum is not yet indexed.';
