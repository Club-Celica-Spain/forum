...
$txt['activate_after_registration'] = 'Gracias por registrarte. Recibir&aacute;s en breve un email con un enlace para activar tu cuenta. Si usted no recive el e-mail luego de un tiempo, revise su carpeta de SPAM.';
...
$txt['admin_setting_password_strength'] = 'Fuerza requerida para las contrase&ntildes;as del usuario';
$txt['admin_setting_password_strength_low'] = 'Baja - 4 car&aacute;cteres como m&iacute;nimo ';
$txt['admin_setting_password_strength_medium'] = 'Media - no puede contener un nombre de usuario';
$txt['admin_setting_password_strength_high'] = 'Alta - mezcla de diversos car&aacute;cteres';
