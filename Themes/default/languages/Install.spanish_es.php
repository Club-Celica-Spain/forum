...
$txt['install_settings_stats_info'] = 'Al activar esta opción permitirás a Simple Machines que visite tu web una vez al mes para recopilar estadísticas básicas. Esto nos ayudará a tomar decisiones acerca de las configuraciones que pueden optimizar el software. Para más información, por favor visita nuestra <a href="http://www.simplemachines.org/about/stats.php" target="_blank">página de información</a> (en inglés).';
...
$txt['db_settings_type_info'] = 'Se han detectado múltiples tipos de bases de datos compatibles (cual quieres utilizar). Por favor, ten en cuenta que no es posible usar versiones anteriores a la SMF 2.0 RC3 junto con versiones posteriores en la misma base de datos PostgreSQL. En ese caso, deberás actualizar tus instalaciones anteriores.';
...
$txt['db_sqlite_warning'] = 'Sólo recomendado para foros pequeños, con bajo volumen y/o foros de tipo intranet. Por favor, ten en cuenta que esta opción será eliminada en futuras versiones.';
...
$txt['user_settings_username_info'] = 'Especifica el nombre con el que te identificarás.<br />Este nombre NO podrá ser cambiado después, pero sí el nombre que se mostrará.';
...
$txt['error_already_installed'] = 'El instalador ha detectado que ya tienes SMF instalado. Se recomienda encarecidamente que <strong>no</strong> intentes sobreescribir la instalación existente - continuar con la instalación <strong>puede ocasionar la pérdida o corrupción de los datos existentes</strong>.<br /><br />Si quieres actualizar, por favor visita la <a href="http://www.simplemachines.org">web de Simple Machines</a> y descárgate el último paquete de <em>actualización (upgrade)</em>.<br /><br />Si quieres sobreescribir tu instalación existente, incluyendo todos los datos, se recomienda que borres las tablas existentes de la base de datos, reemplaces el archivo Settings.php antes de intentar de nuevo la instalación.';
$txt['error_warning_notice'] = '¡Advertencia!';
$txt['error_script_outdated'] = '¡Este instalador está obsoleto! La versión actual de SMF es %1$s pero este instalador es para %2$s.<br /><br />Se recomienda que visites la página de <a href="http://www.simplemachines.org">Simple Machines</a> para poder obtener versión más reciente.';
