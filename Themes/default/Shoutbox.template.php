...
function template_shoutbox($main = false)
{
				...
				<span class="topslice"><span></span></span>
					...
					echo'
						<div class="smalltext" style="text-align: right;">
							...
							<span id="shoutbox_bar"> | <a title="Powered by SMFPacks.com" target="_blank" href="https://www.smfpacks.com/">&copy;</a></span>
						</div>';
	...
	<div style="height:0.1em">
		<object id="shoutbox_object" width="1" height="1" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="https://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0">
			<param name="movie" value="', $settings['default_theme_url'], '/shoutbox.swf?dir=', $boardurl, '"></param>
			<param name="quality" value="high"></param>
			<embed id="shoutbox_embed" src="', $settings['default_theme_url'], '/shoutbox.swf?dir=', $boardurl, '" width="1" height="1" quality="high" pluginspage="https://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash"></embed>
		</object>
	</div>';
	...
	<div style="margin:5px">
		...
		echo '
			<div class="windowbg smalltext" style="padding:0.5em 0.6em;text-align:right">
				...
				| <a title="SMFPacks.com" target="_blank" href="https://www.smfpacks.com/">&copy;</a>
			</div>';
