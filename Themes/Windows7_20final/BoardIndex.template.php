...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
		...
		echo '
			<tbody class="header">
				<tr>
					<td colspan="5"><div class="tcat"><div class="tcat_right"><div class="tcat_left">';
		...
		if (!$category['is_collapsed'])
		{
			...
			foreach ($category['boards'] as $board)
			{
				...
				echo '
					...
					<td class="info">
						<div style="float: right;">
							<a href="'.$scripturl.'?action=.xml;type=rss;board='.$board['id'].'">	
								<img title="rss" alt="rss" src="',$settings['images_url'],'/rss.gif" />
							</a>
						</div>
				...
				if (!empty($board['last_post']['id']))
					echo '
						<img src="',$settings['images_url'],'/icon1.gif" alt="" />&nbsp;<strong style="color: #c5082b;">', $board['last_post']['link'], '</strong><br />
						', $txt['by'], ': ', $board['last_post']['member']['link'] , '
						<br />
						<div align="right">
							<img style="vertical-align: middle;"src="',$settings['images_url'],'/lastpost.gif" alt="" />&nbsp;', $board['last_post']['time'],'
						</div>
						';
				echo '
					</td>
					<td class="stats windowbg" align="center">
...
function template_info_center()
{
	...
	{
		echo '
			<div class="titlebg" style="color: white; font-weight: bold; padding: 3px;">
				', $txt['recent_posts'], '
			</div>
			<table cellspacing="0" class="windowbg" style="width: 100%;">
				<tr>
