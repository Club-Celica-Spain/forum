...
function template_main()
{
	...
	{
		echo '
				<p id="whoisviewing" class="whoisviewing">';
	...
	while ($message = $context['get_message']())
	{
		...
		if ($message['id'] != $context['first_message'])
		{
			...
			echo'<div class="',$message['alternate'] == 0 ? 'cat' : 'title' ,'_bar">
			<h4 class="',$message['alternate'] == 0 ? 'catbg' : 'titlebg' ,'">',$message['subject'],'</h4></div>';
		}
