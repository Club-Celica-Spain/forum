...
function template_main()
{
	...
	<table border="0" width="100%" class="tborder" cellspacing="' , ($context['browser']['is_ie'] || $context['browser']['is_opera6']) ? '1' : '0' , '" cellpadding="4" style="margin-bottom: 2ex;">
		<tr>
			<td class="catbg" style="padding: 10px 5px 10px 10px;"> &nbsp;', $txt[102], '</td>
		</tr>
		<tr>
	...
	<div class="tborder" style="margin-top: ' , $first ? '0;' : '1ex;' , '' , $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? 'width: 100%;' : '', '">
		<div class="catbg', $category['new'] ? '2' : '', '" style="padding: 10px 5px 10px 10px;">';
		$first = false;
		...
		echo '
				...
				<tr>
					<td class="windowbg" width="20" valign="middle" align="center">
						<a href="', $scripturl, '?action=recent"><img src="', $settings['images_url'], '/xx.png" alt="', $txt[214], '" /></a>
					</td>
					<td class="windowbg2">';
	...
	if ($context['show_calendar'])
	{
		echo '
				<tr>
					...
					<td class="windowbg" width="20" valign="middle" align="center">
						<a href="', $scripturl, '?action=calendar"><img src="', $settings['images_url'], '/calendar.png" alt="', $txt['calendar24'], '" /></a>
					</td>
	...
	if ($settings['show_sp1_info'])
	{
		echo '
				...
				<tr>
					<td class="windowbg" width="20" valign="middle" align="center">
						<a href="', $scripturl, '?action=stats"><img src="', $settings['images_url'], '/stats.png" alt="', $txt[645], '" /></a>
					</td>
					<td class="windowbg2" width="100%">
	...
	echo '
				<tr>
					...
					<td rowspan="2" class="windowbg" width="20" valign="middle" align="center">
						', $context['show_who'] ? '<a href="' . $scripturl . '?action=who">' : '', '<img src="', $settings['images_url'], '/users.png" alt="', $txt[158], '" />', $context['show_who'] ? '</a>' : '', '
					</td>
					<td class="windowbg2" width="100%">';
		...
		echo '
				...
				<tr>
					<td class="windowbg" width="20" align="center">
						<a href="', $scripturl, '?action=login"><img src="', $settings['images_url'], '/login.png" alt="', $txt[34], '" /></a>
					</td>
