...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		...
		array(
                        'id' => 'display_facebook_like',
                        'label' => $txt['display_facebook_like'],
                        'description' => $txt['display_facebook_like_desc'],
        ),
		array(
                        'id' => 'display_facebook_like_all',
                        'label' => $txt['display_facebook_like_all'],
                        'description' => $txt['display_facebook_like_all_desc'],
        ),
		array(
			'id' => 'hide_post_group',
		...
		array(
			'id' => 'custom_code',
			'label' => $txt['custom_code'],
			'description' => $txt['custom_code_description'],
			'type' => 'text',
		),
	);
}
