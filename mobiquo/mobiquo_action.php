...
function action_sign_in()
{
    ...
    if ($is_register)
    {
        // registration disabled in SMF system
        if (isset($modSettings['registration_method']) && $modSettings['registration_method'] == 3)
            fatal_lang_error('registration_disabled', false);

        // in app registration was disabled
        if (isset($modSettings['tp_iar_registration_options']) && $modSettings['tp_iar_registration_options'] == 0)
            fatal_lang_error('registration_disabled', false);
    }
