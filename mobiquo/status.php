...
class MbqStatus extends MbqBaseStatus
{
    ...
    protected function GetBYOInfo()
    {
        ...
        $TT_bannerControlData = isset($modSettings['tt_banner_control']) ? $modSettings['tt_banner_control'] : false;
        if ($TT_bannerControlData)  $TT_bannerControlData = @unserialize($TT_bannerControlData);
