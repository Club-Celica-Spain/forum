...
function loadBoard()
{
	...
	if (empty($temp))
	{
		$request = $smcFunc['db_query']('', '
            ...
            (isset($modSettings['integrate_pre_include']) && strpos($modSettings['integrate_pre_include'],'$sourcedir/Subs-ThankYou.php') ? 'b.thank_you_post_enable,' : '').' b.redirect,
...
function smfVersionbeyond2016(){
    global $modSettings;

    $version = isset($modSettings['tt_forum_version']) ? $modSettings['tt_forum_version'] : $modSettings['smfVersion'];
