	...
	$admin_areas = array(
			...
			'areas' => array(
				...
				'modsettings' => array(
					...
					'subsections' => array(
                        ...
                        'custombuttons' => array  ($txt['custombuttons_settings_menu']),
					),
				),
			),
		),
		...
		'layout' => array(
			...
			'areas' => array(
		      ...
		      'prefix' => array(
					'label' => $txt['prefix_admin'],
					'file' => 'TopicPrefix.php',
					'function' => 'PrefixMain',
					'custom_url' => $scripturl . '?action=admin;area=prefix;sa=admin;sesc=' . $sc,
					'icon' => 'prefix.gif',
                    'subsections' => array(
					    'admin' => array($txt['prefix_admin'], 'admin_forum'),
					    'add' => array($txt['prefix_add'], 'admin_forum'),
                        'version' => array($txt['prefix_version'], 'admin_forum'),  						
					),					
				),
