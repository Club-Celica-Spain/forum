 ...
 * @license https://www.mozilla.org/MPL/MPL-1.1.html
 *
 * @version 1.0.5
 */
 ...
 * License.
 *
 * The Original Code is https://www.labradoodle-360.com code.
 *
...
function MenuEditorMaddify()
{
	...
	if (isset($_POST['name']))
	{
		...
		if (!empty($_POST['link_type']) && $_POST['link_type'] == 2 && (empty($_POST['external_link']) || $_POST['external_link'] == 'https://'))
