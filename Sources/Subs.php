...
{
	global $context, $settings, $modSettings, $txt, $smcFunc, $remember_old_url, $boarddir;
...
function setupMenuContext()
{
	...
	$context['allow_admin'] = allowedTo(array('adk_portal','admin_forum', 'manage_boards', 'manage_permissions', 'moderate_forum', 'manage_membergroups', 'manage_bans', 'send_mail', 'edit_news', 'manage_attachments', 'manage_smileys'));
	...
	if (($menu_buttons = cache_get_data('menu_buttons-' . implode('_', $user_info['groups']) . '-' . $user_info['language'], $cacheTime)) === null || time() - $cacheTime <= $modSettings['settings_updated'])
	{
		$buttons = array(
			...
			'search' => array(
				'title' => $txt['search'],
				'href' => 'http://foro.clubcelica.es/search.php',
