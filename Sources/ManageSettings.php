...
function ModifycustombuttonsSettings($return_config = false)
{
    ...
    $config_vars = array(
        ...
        array('text', 'label_custombuttons_1'),
        array('text', 'url_custombuttons_1'),
                //Subs for button 1 - 4
        array('text', 'label_subcustombuttons1_1'),
        array('text', 'url_subcustombuttons1_1'),
        array('text', 'label_subcustombuttons1_2'),
        array('text', 'url_subcustombuttons1_2'),
        array('text', 'label_subcustombuttons1_3'),
        array('text', 'url_subcustombuttons1_3'),
        array('text', 'label_subcustombuttons1_4'),
        array('text', 'url_subcustombuttons1_4'),
        '',
                //Button 2
                $txt['button2'],
        array('check', 'enable_custombuttons_2'),
        array('text', 'label_custombuttons_2'),
        array('text', 'url_custombuttons_2'),
                //Subs for button 2 - 4
        array('text', 'label_subcustombuttons2_1'),
        array('text', 'url_subcustombuttons2_1'),
        array('text', 'label_subcustombuttons2_2'),
        array('text', 'url_subcustombuttons2_2'),
        array('text', 'label_subcustombuttons2_3'),
        array('text', 'url_subcustombuttons2_3'),
        array('text', 'label_subcustombuttons2_4'),
        array('text', 'url_subcustombuttons2_4'),
        '',
                //Button 3
                $txt['button3'],
        array('check', 'enable_custombuttons_3'),
        array('text', 'label_custombuttons_3'),
        array('text', 'url_custombuttons_3'),
                //Subs for button 3 - 4
        array('text', 'label_subcustombuttons3_1'),
        array('text', 'url_subcustombuttons3_1'),
        array('text', 'label_subcustombuttons3_2'),
        array('text', 'url_subcustombuttons3_2'),
        array('text', 'label_subcustombuttons3_3'),
        array('text', 'url_subcustombuttons3_3'),
        array('text', 'label_subcustombuttons3_4'),
        array('text', 'url_subcustombuttons3_4'),
        '',
                //Button 4
                $txt['button4'],
        array('check', 'enable_custombuttons_4'),
        array('text', 'label_custombuttons_4'),
        array('text', 'url_custombuttons_4'),
                //Subs for button 4 - 4
        array('text', 'label_subcustombuttons4_1'),
        array('text', 'url_subcustombuttons4_1'),
        array('text', 'label_subcustombuttons4_2'),
        array('text', 'url_subcustombuttons4_2'),
        array('text', 'label_subcustombuttons4_3'),
        array('text', 'url_subcustombuttons4_3'),
        array('text', 'label_subcustombuttons4_4'),
        array('text', 'url_subcustombuttons4_4'),
        '',

                //Button 5
                $txt['button5'],
        array('check', 'enable_custombuttons_5'),
        array('text', 'label_custombuttons_5'),
        array('text', 'url_custombuttons_5'),
                //Subs for button 5 - 4
        array('text', 'label_subcustombuttons5_1'),
        array('text', 'url_subcustombuttons5_1'),
        array('text', 'label_subcustombuttons5_2'),
        array('text', 'url_subcustombuttons5_2'),
        array('text', 'label_subcustombuttons5_3'),
        array('text', 'url_subcustombuttons5_3'),
        array('text', 'label_subcustombuttons5_4'),
        array('text', 'url_subcustombuttons5_4'),
        '',
        
            //Button 6
            $txt['button6'],
        array('check', 'enable_custombuttons_6'),
        array('text', 'label_custombuttons_6'),
        array('text', 'url_custombuttons_6'),
                //Subs for button 6 - 4
        array('text', 'label_subcustombuttons6_1'),
        array('text', 'url_subcustombuttons6_1'),
        array('text', 'label_subcustombuttons6_2'),
        array('text', 'url_subcustombuttons6_2'),
        array('text', 'label_subcustombuttons6_3'),
        array('text', 'url_subcustombuttons6_3'),
        array('text', 'label_subcustombuttons6_4'),
        array('text', 'url_subcustombuttons6_4'),
        
    );
    if ($return_config)
        return $config_vars;

    $context['post_url'] = $scripturl . '?action=admin;area=modsettings;save;sa=custombuttons';
    $context['settings_title'] = $txt['custombuttons_settings_menu'];
    ...
    if (isset($_GET['save']))
    {
        ...
        redirectexit('action=admin;area=modsettings;sa=custombuttons');
    }
    prepareDBSettingContext($config_vars);
...
function ModifyInactiveMessageSettings($return_config = false) {

	global $context, $txt, $scripturl, $modSettings, $settings;

	$config_vars = array(
	    array('text', 'inactive_users'),
		'',
		array('check', 'show_index_message'),
		array('text', 'index_message_title'),
		array('large_text', 'index_message_body'),
		'',
		array('check', 'show_footer_message'),
		array('text', 'footer_message_title'),
		array('large_text', 'footer_message_body'),
	);
	...
	if (isset($_GET['save'])) {
		...
		redirectexit('action=admin;area=modsettings;sa=inactivemessage');
	}

	$context['post_url'] = $scripturl . '?action=admin;area=modsettings;save;sa=inactivemessage';
