...
function Post()
{
	...
	WHERE (FIND_IN_SET(' . implode(', permissions) OR FIND_IN_SET(', $user_info['groups']) . ', permissions))
...
function Post2()
{
	...
	else
	{
		...
		if ($smcFunc['htmltrim'](strip_tags(parse_bbc($_POST['message'], false), '<img><iframe><object><embed>')) === '' && (!allowedTo('admin_forum') || strpos($_POST['message'], '[html]') === false))
			$post_errors[] = 'no_message';
	}
	...
	@set_time_limit(300);//Topic Prefix Mod
